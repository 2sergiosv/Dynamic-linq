 public static class ExpressionBuilder
    ...
    {
        public static IQueryable<TSource> WhereFilters<TSource>(this IQueryable<TSource> source, List<Filter> filters)
        {
            if (filters == null || filters.Count == 0)
                return source;
            return source.Where(ExpressionBuilder.GetExpression<TSource>(filters));
        }
    }
